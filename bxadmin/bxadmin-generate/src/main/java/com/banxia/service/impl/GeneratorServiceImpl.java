...
import com.banxia.domain.ColumnInfo;
import com.banxia.domain.GenConfig;
import com.banxia.domain.vo.TableInfo;
import com.banxia.exception.RequestException;
import com.banxia.repository.ColumnInfoRepository;
import com.banxia.service.GeneratorService;
import com.banxia.utils.FileUtil;
import com.banxia.utils.GenUtil;
...
public class GeneratorServiceImpl implements GeneratorService {
    ...
    public void generator(GenConfig genConfig, List<ColumnInfo> columns) {
        if (genConfig.getId() == null) {
            throw new RequestException("请先配置生成器");
        }
        try {
            GenUtil.generatorCode(columns, genConfig);
        } catch (IOException e) {
            log.error(e.getMessage(), e);
            throw new RequestException("生成失败，请手动处理已生成的文件");
        }
    }
    ...
    public void download(GenConfig genConfig, List<ColumnInfo> columns, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            throw new RequestException("打包失败");
        }
    }
}
