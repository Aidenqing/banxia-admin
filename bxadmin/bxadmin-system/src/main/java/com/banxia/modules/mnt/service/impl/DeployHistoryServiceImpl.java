...
import com.banxia.modules.mnt.repository.DeployHistoryRepository;
import com.banxia.modules.mnt.service.DeployHistoryService;
import com.banxia.modules.mnt.service.dto.DeployHistoryDto;
import com.banxia.modules.mnt.service.dto.DeployHistoryQueryCriteria;
import com.banxia.modules.mnt.service.mapstruct.DeployHistoryMapper;
import com.banxia.utils.FileUtil;
import com.banxia.utils.PageUtil;
import com.banxia.utils.QueryHelp;
import com.banxia.utils.ValidationUtil;
...
public class DeployHistoryServiceImpl implements DeployHistoryService {
    ...
    public List<DeployHistoryDto> queryAll(DeployHistoryQueryCriteria criteria){
        return deployhistoryMapper.toDto(deployhistoryRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp
