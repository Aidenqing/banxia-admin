...
import com.banxia.modules.system.domain.Dept;
import com.banxia.modules.system.domain.User;
import com.banxia.modules.system.repository.DeptRepository;
import com.banxia.modules.system.repository.RoleRepository;
import com.banxia.modules.system.repository.UserRepository;
import com.banxia.modules.system.service.DeptService;
import com.banxia.modules.system.service.dto.DeptDto;
import com.banxia.modules.system.service.dto.DeptQueryCriteria;
import com.banxia.modules.system.service.mapstruct.DeptMapper;
import com.banxia.utils.*;
import com.banxia.utils.enums.DataScopeEnum;
...
public class DeptServiceImpl implements DeptService {
    ...
    public void verification(Set<DeptDto> deptDtos) {
        ...
        if (userRepository.countByDepts(deptIds) > 0) {
            throw new RequestException("所选部门存在用户关联，请解除后再试！");
        }
        if (roleRepository.countByDepts(deptIds) > 0) {
            throw new RequestException("所选部门存在角色关联，请解除后再试！");
        }
    }
