...
import com.banxia.modules.system.domain.vo.MenuMetaVo;
import com.banxia.modules.system.domain.vo.MenuVo;
import com.banxia.modules.system.repository.MenuRepository;
import com.banxia.modules.system.repository.UserRepository;
import com.banxia.modules.system.service.MenuService;
import com.banxia.modules.system.service.RoleService;
import com.banxia.modules.system.service.dto.MenuDto;
import com.banxia.modules.system.service.dto.MenuQueryCriteria;
import com.banxia.modules.system.service.dto.RoleSmallDto;
import com.banxia.modules.system.service.mapstruct.MenuMapper;
    ...
    public void create(Menu resources) {
        ...
        if(resources.getIFrame()){
            ...
            if (!(resources.getPath().toLowerCase().startsWith(http)||resources.getPath().toLowerCase().startsWith(https))) {
                throw new RequestException("外链必须以http://或者https://开头");
            }
        }
