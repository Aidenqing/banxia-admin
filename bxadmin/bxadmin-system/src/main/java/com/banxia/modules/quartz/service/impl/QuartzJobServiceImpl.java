 ...
 */
package com.banxia.modules.quartz.service.impl;

import cn.hutool.core.util.IdUtil;
import com.banxia.exception.RequestException;
import com.banxia.modules.quartz.domain.QuartzJob;
import com.banxia.modules.quartz.domain.QuartzLog;
import com.banxia.modules.quartz.repository.QuartzJobRepository;
import com.banxia.modules.quartz.repository.QuartzLogRepository;
import com.banxia.modules.quartz.service.QuartzJobService;
import com.banxia.modules.quartz.service.dto.JobQueryCriteria;
import com.banxia.modules.quartz.utils.QuartzManage;
...
public class QuartzJobServiceImpl implements QuartzJobService {
    ...
    public void create(QuartzJob resources) {
        if (!CronExpression.isValidExpression(resources.getCronExpression())){
            throw new RequestException("cron表达式格式错误");
        }
    ...
    public void update(QuartzJob resources) {
        ...
        if(StringUtils.isNotBlank(resources.getSubTask())){
            ...
            if (tasks.contains(resources.getId().toString())) {
                throw new RequestException("子任务中不能添加当前任务ID");
            }
        }
        resources = quartzJobRepository.save(resources);
