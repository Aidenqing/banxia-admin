 ...
 */
package com.banxia.modules.mnt.service.impl;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import com.banxia.exception.RequestException;
import com.banxia.modules.mnt.domain.App;
import com.banxia.modules.mnt.domain.Deploy;
import com.banxia.modules.mnt.domain.DeployHistory;
import com.banxia.modules.mnt.domain.ServerDeploy;
import com.banxia.modules.mnt.repository.DeployRepository;
import com.banxia.modules.mnt.service.DeployHistoryService;
import com.banxia.modules.mnt.service.DeployService;
import com.banxia.modules.mnt.service.ServerDeployService;
import com.banxia.modules.mnt.service.dto.AppDto;
import com.banxia.modules.mnt.service.dto.DeployDto;
import com.banxia.modules.mnt.service.dto.DeployQueryCriteria;
import com.banxia.modules.mnt.service.dto.ServerDeployDto;
import com.banxia.modules.mnt.service.mapstruct.DeployMapper;
import com.banxia.modules.mnt.util.ExecuteShellUtil;
import com.banxia.modules.mnt.util.ScpClientUtil;
import com.banxia.modules.mnt.websocket.MsgType;
import com.banxia.modules.mnt.websocket.SocketMsg;
import com.banxia.modules.mnt.websocket.WebSocketServer;
import com.banxia.utils.*;
...
public class DeployServiceImpl implements DeployService {
	...
	private void deployApp(String fileSavePath, Long id) {
		...
		if (deploy == null) {
			...
			throw new RequestException("部署信息不存在");
		}
		AppDto app = deploy.getApp();
		if (app == null) {
			sendMsg("包对应应用信息不存在", MsgType.ERROR);
			throw new RequestException("包对应应用信息不存在");
		}
	...
	public String serverReduction(DeployHistory resources) {
		...
		if (app == null) {
			...
			throw new RequestException("应用信息不存在：" + resources.getAppName());
		}
	...
	private ExecuteShellUtil getExecuteShellUtil(String ip) {
		...
		if (serverDeployDTO == null) {
			...
			throw new RequestException("IP对应服务器信息不存在：" + ip);
		}
